...
void setup() {
    ...
    oled.clear(PAGE);  // erases the screen
...
void loop() {
    ...
    /*
        ...
        pot1 will control the x direction
        pot2 will control the y direction
        button will erase the screen to start over

        build a latch for button
            clear the page of oled

        read xPot and yPot
        xPot: 0-4095 ----> xPixel: 0-63 or 0-oled.getLCDWidth
        xPot: ...
    ...
    */
    ...
    if (currButtonState == LOW && prevButtonState == HIGH) {
        oled.clear(PAGE);
        Serial.println("width" + String(oled.getLCDWidth() )+ ", height:" + String(oled.getLCDHeight()));
