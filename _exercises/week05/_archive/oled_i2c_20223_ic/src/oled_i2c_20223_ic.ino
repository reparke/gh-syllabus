...
/*
    approach / algorithm for etch a sketch
        two pots  0-4095

    read in pot value 0-4095
    x pixel variable 0 to screen width
    y pixel variable 0 to screen height

    convert between pot values and x pixel and y pixel

    draw the pixel

    add in button latch code to reset drawing (erase screen)
