...
/*
    ...
    How to find library?
    - search the Particle library database
    - look on community.particle.io
    - the internet
    - documenation for the manufacturer
*/
...
MicroOLED oled(MODE_I2C, 9,
               1);  // this is the declaration ALWAYS use with this screen
...
void loop() {
    ...
    /*
        build etch a sketch
        - pot1 will control x direction
        - pot2 will control y direction
        - button (latch) will erase screen

        plan
        - button pressed -> clear PAGE
        - pot1 -> ADC 0-4095 ---> map to the OLED screen width
        - pot2 -> map to OLED screen height
        - draw the dot
    */

    // we know the screen is 64x48
