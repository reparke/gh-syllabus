...
/*
    what is a library?
    -
    file(s) with a lots of fn we can access

    where do you find libraries
    0) particle library database
    1) internet
    2) community.particle.io
*/
...
/*
    ...
    -
    pot1 will control the x dir
    pot2 will control the y dir
    button will reset / erase the screen (could be a latch)

    generate an x y coordinate
    make a dot appear on the screen
