// new particle workbench templates
...
void setup() {
    analogRead(pulseSignalPin); //this a workaround for a library problem
...
// Interval (IBI) in mS
void PulseSensorAmped_data(int BPM, int IBI) {  //we don't call this, it is called automatically
    Serial.print("BPM:");
    Serial.print(BPM);
    Serial.print(" IBI: ");
    Serial.println(IBI);
