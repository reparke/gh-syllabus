...
I updated this SPI OLED + MAX30101 code to use I2C OLED, and it started
glitching. https://forum.sparkfun.com/viewtopic.php?f=143&t=56434

It seems to have been caused by the timer-controlled MAX30101 sensors reads.
These may have been too fast. As a result, the OLED screen draws were distorted.
I created a new version of this code that does not use timers
*/
