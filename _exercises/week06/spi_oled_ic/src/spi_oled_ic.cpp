...
#line 1 "c:/Users/Rob/Documents/_GitHub/ITP_348_Content_Public/_exercises/week06/spi_oled_ic/src/spi_oled_ic.ino"
/******************************************************************************
...
#line 44 "c:/Users/Rob/Documents/_GitHub/ITP_348_Content_Public/_exercises/week06/spi_oled_ic/src/spi_oled_ic.ino"
const int PIN_DC = D5;
...
/*
define the maxHeight and maxWdith

  get analog input 0-4095
    when potX is 0, so we to show at 0 on the screen
    when potX is at 4095, maxWidth

    after conversion, have soem conditional logic to keep from going off the screen
...
void setup()
{
  //setup: always called OLED.begin()
...
{
  oled.clear(PAGE);
  oled.setFontType(0);    // set the smallest font
  oled.setCursor(0, 0);   //move writing to 0 rows, 0 columns (top right corner)
...
void textExamples()
{
  ...
  oled.setFontType(0);  // Set font to type 0     //0 smallest font.
